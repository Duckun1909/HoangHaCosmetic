...
import chongnang1 from '~/assets/img/chongnangaw/PhotoRoom_20230619_154523.jpg';
import chongnang2 from '~/assets/img/chongnangaw/PhotoRoom_20230619_155933.jpg';
import { ProductPreviewModules } from '~/CssModules';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faAngleLeft, faAngleRight, faMinus, faPlus } from '@fortawesome/free-solid-svg-icons';
import './modalDialog.css';
import { useRef } from 'react';

const cx = ProductPreviewModules();
...
function ProductPreview({ handleVisible, visible }) {
    ...
    return (
        <Modals mw="1070px" size="xl" animation="fade" handleVisible={handleVisible} visible={visible}>
            <div className={cx('wrapper')}>
                <div className="container p-0" style={{maxHeight: "inherit"}}>
                    <div className="row g-0" style={{maxHeight: "inherit"}}>
                        <div className={cx('item', { 'prd-thumb': true }, 'col-6')} style={{maxHeight: "inherit"}}>
                            <Slider ref={sliderRef} {...settings}>
                                <div>
                                    <img src={chongnang1}></img>
                                </div>
                                <div>
                                    <img src={chongnang2}></img>
                                </div>
                            </Slider>
                        ...
                        <div className={cx('item', { 'prd-info': true }, 'col-6')} style={{maxHeight: "inherit"}}>
                            <div className={cx('content')}>
                                ...
                                <p className={cx('prd-desc')}>
                                    The EcoSmart Fleece Hoodie full-zip hooded jacket provides medium weight fleece
