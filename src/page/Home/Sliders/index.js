            ...
            <Slider {...settings}>
                <div className={cx('item')}>
                    <div
                        ...
                        style={{
                            backgroundImage:
                                'url("https://wpbingosite.com/wordpress/cerla/wp-content/uploads/2021/02/slider4-1.jpg")',
                        }}
                    ></div>
                ...
                <div className={cx('item')}>
                    <div
                        ...
                        style={{
                            backgroundImage:
                                'url("https://wpbingosite.com/wordpress/cerla/wp-content/uploads/2021/02/slider4-3.jpg")',
                        }}
                    ></div>
                    <div className={cx('content')}>
                ...
                <div className={cx('item')}>
                    <div
                        ...
                        style={{
                            backgroundImage:
                                'url("https://wpbingosite.com/wordpress/cerla/wp-content/uploads/2021/02/slider4-4.jpg")',
                        }}
                    ></div>
                    <div className={cx('content')}>
