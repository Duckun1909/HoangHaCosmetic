import { ProductInfoModules } from '~/CssModules';
...
import TrendingProducts from '~/page/Home/TrendingProducts';

const cx = ProductInfoModules();
    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('content')}>
                ...
                <TrendingProducts titleComponent="related products" />
            </div>
        </div>
    );
}
